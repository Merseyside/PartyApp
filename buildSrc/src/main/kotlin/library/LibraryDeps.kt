    ...
    object Libs {
        object Android {
            ...
            val rxjava2 = AndroidLibrary(
                name = "io.reactivex.rxjava2:rxjava:${Versions.Libs.Android.rxjava2}"
            )
            val paging = AndroidLibrary(
                name = "androidx.paging:paging-runtime:${Versions.Libs.Android.paging}"
            )
            ...
            val room = AndroidLibrary(
                name = "androidx.room:room-runtime:${Versions.Libs.Android.room}"
            )
            val roomCompiler = KaptLibrary(
                name = "androidx.room:room-compiler:${Versions.Libs.Android.room}"
            )
            val roomKtx = KaptLibrary(
                name = "androidx.room:room-ktx:${Versions.Libs.Android.room}"
            )
            ...
            val coil = AndroidLibrary(
                name = "io.coil-kt:coil:${Versions.Libs.Android.coil}"
            )
        }
        ...
        object MultiPlatform {
            ...
            val serialization = MultiPlatformLibrary(
                android = "org.jetbrains.kotlinx:kotlinx-serialization-json:${Versions.Common.serialization}",
                common = "org.jetbrains.kotlinx:kotlinx-serialization-json:${Versions.Common.serialization}",
                ios = "org.jetbrains.kotlinx:kotlinx-serialization-json:${Versions.Common.serialization}"
            )
            val ktorClient = MultiPlatformLibrary(
                android = "io.ktor:ktor-client-android:${Versions.Libs.MultiPlatform.ktor}",
                common = "io.ktor:ktor-client-core:${Versions.Libs.MultiPlatform.ktor}",
                ios = "io.ktor:ktor-client-ios:${Versions.Libs.MultiPlatform.ktor}"
            )
