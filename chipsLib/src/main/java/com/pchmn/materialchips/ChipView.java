...
public class ChipView extends RelativeLayout {
    ...
    private List<OnChipClickListener> onClickListenerList;
    ...
    public void setOnChipClicked(OnChipClickListener listener) {
        ...
        mContentLayout.setOnClickListener(v -> {
            for (int i = 0; i < onClickListenerList.size(); i++) {
                onClickListenerList.get(i).onClick(this);
            }
        });
    }
    ...
    public static class Builder {
        ...
        public Builder selectedColor(ColorStateList selectedColor) {
            this.selectedColor = selectedColor;
            return this;
        }

        public Builder selectedTextColor(ColorStateList selectedTextColor) {
